    ...
    return a.widget("ui.tabs", {
        ...
        _initialActive: function () {
            ...
            return (
                ...
                b !== !1 &&
                ((b = this.tabs.index(this.tabs.eq(b))), b === -1 && (b = !c && 0)),
        ...
        _findNextTab: function (b, c) {
            ...
            for (
                var e = this.tabs.length - 1; a.inArray(d(), this.options.disabled) !== -1;
        ...
        _processTabs: function () {
            ...
            (this.tablist = this._getList()
                ...
                .attr("role", "tablist")
                .delegate("> li", "mousedown" + this.eventNamespace, function (b) {
        ...
        _setupDisabled: function (b) {
            ...
            for (var c, d = 0;
                (c = this.tabs[d]); d++)
                b === !0 || a.inArray(d, b) !== -1 ?
                    a(c).addClass("ui-state-disabled").attr("aria-disabled", "true") :
                    a(c).removeClass("ui-state-disabled").removeAttr("aria-disabled");
