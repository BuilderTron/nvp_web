...
(function ($) {
	...
	var moveThumbsInPosition = function (container, opt) {
		var thumbs = container.hasClass("tp-thumbs") ? ".tp-thumbs" : ".tp-tabs",
			...
			tw =
				thumbdir === "vertical" ?
					t.find(thumb).first().outerHeight(true) + opt.space :
					t.find(thumb).first().outerWidth(true) + opt.space,
			...
			swipeStatus: function (
				...
				// SWIPE OVER THUMBS OR TABS
					...
					var t = container.parent().find(thumbmask),
						...
						tw =
							tdir === "vertical" ?
								t.find(thumb).first().outerHeight(true) + _o.space :
								t.find(thumb).first().outerWidth(true) + _o.space,
						newpos =
			...
			a =
				o.v_align === "top" ?
					...
					o.v_align === "center" ?
						...
						{
							top: "100%",
							y: Math.round(0 - (elh + o.v_offset + by)) + "px"
						};
			...
			a =
				o.h_align === "left" ?
					...
					o.h_align === "center" ?
						...
						{
							left: "100%",
							x: Math.round(0 - (elw + o.h_offset + bx)) + "px"
						};
