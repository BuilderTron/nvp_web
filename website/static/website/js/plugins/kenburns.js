    ...
    $.fn.kenburned = function (options) {
        ...
        function update() {
            ...
            if (time_passed < fade_time) {
                ...
                var bottom_frame_start_time =
                    frame_start_time - display_time + fade_time;
                var bottom_time_passed = update_time - bottom_frame_start_time;
                if (update_time < fade_time) {
                    clear();
                } else {
                    render_image(
                        wrap_index(bottom_frame),
                        bottom_time_passed / display_time,
                        1
                    );
                }
            }
            ...
            render_image(
                wrap_index(top_frame),
                time_passed / display_time,
