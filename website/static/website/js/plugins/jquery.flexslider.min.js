        ...
        e.data(a, "flexslider", i),
                ...
                directionNav: {
                    setup: function () {
                        ...
                        i.customDirectionNav ?
                            ...
                            (i.append(t),
                                (i.directionNav = e("." + s + "direction-nav li a", i))),
                    ...
                    o
                                        ...
                                        e.detail !== e.MSGESTURE_FLAG_INERTIA ?
                                            ...
                                            (e.preventDefault(),
                                                ...
                                                (t.vars.animationLoop ||
                                                    (s =
                                                        y /
                                                        ((0 === t.currentSlide && y < 0) ||
                                                            (t.currentSlide === t.last && y > 0) ?
                                                            Math.abs(y) / r + 2 :
                                                            1)),
                                                    t.setProps(n + s, "setTouch"))) :
                        ...
                        ((c = function (s) {
                            ...
                            (d = function (a) {
                                (h = a.touches[0].pageX),
                                (S = a.touches[0].pageY),
                                (s = u ? e - S : (i.vars.rtl ? -1 : 1) * (e - h));
                                (!(g = u ?
                                        Math.abs(s) < Math.abs(h - t) :
                                        Math.abs(s) < Math.abs(S - t)) ||
                                ...
                                (a.preventDefault(),
                                    ...
                                    (i.vars.animationLoop ||
                                        (s /=
                                            ...
                                            Math.abs(s) / r + 2 :
                                            1),
                                        i.setProps(n + s, "setTouch")));
                            }),
                            (f = function (o) {
                                if (
                                    (a.removeEventListener("touchmove", d, !1),
                                        i.animatingTo === i.currentSlide && !g && null !== s)
                                ) {
                                    var c = v ? -s : s,
                ...
                if (
                    ...
                    if (
                        ...
                        p
                            ...
                            ((d = i.vars.itemMargin),
                                (h =
                                    (S = (i.itemW + d) * i.move * i.animatingTo) > i.limit &&
                                    1 !== i.visible ?
                                    i.limit :
                                    S)) :
                            (h =
            ...
            (i.setProps = function (e, t, a) {
                ...
                i.transitions &&
                    ...
                    (i.args[i.prop] = n),
                    (i.transitions || a === undefined) && i.container.css(i.args),
            ...
            if ((t === undefined && (t = {}), "object" == typeof t))
                return this.each(function () {
                    ...
                    (1 === i.length && !1 === t.allowOneSlide) || 0 === i.length ?
                        ...
                        a.data("flexslider") === undefined && new e.flexslider(this, t);
                });
