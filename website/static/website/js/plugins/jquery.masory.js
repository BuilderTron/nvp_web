...
(function (t) {
        ...
        function i(t) {
            ...
            function o(e, i) {
                t.fn[e] = function (o) {
                    if ("string" == typeof o) {
                        for (
                            var s = n.call(arguments, 1), a = 0, h = this.length; h > a; a++
                        ) {
                            var p = this[a],
                                u = t.data(p, e);
                            if (u)
    ...
    (function (t, e) {
        ...
        function o(t, e) {
            n(t);
            for (
                var i = t.parentNode.querySelectorAll(e), o = 0, r = i.length; r > o; o++
            )
                if (i[o] === t) return !0;
            return !1;
        }
        ...
        var s,
            a = (function () {
                ...
                for (
                    var t = ["webkit", "moz", "ms", "o"], i = 0, n = t.length; n > i; i++
                ) {
                    var o = t[i],
                        r = o + "MatchesSelector";
                    if (e[r]) return r;
    ...
    (function (t) {
        ...
        (r.prototype.settings = {
            ...
            (r.prototype._itemsOn = function (t, e, i) {
                ...
                for (
                    var o = 0, r = t.length, s = this, a = 0, h = t.length; h > a; a++
                ) {
                    var p = t[a];
                    p.on(e, n);
                }
